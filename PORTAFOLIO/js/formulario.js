  function getData() {
    ...
    if (nombre == '' || email == "" || mensaje == '') {
      ...
      document.write('<img src="./img/foto 2.jpeg" alt="" height="150" width="150">');
      document.write('</div>');
      document.write('<p class="carta-titulo">Gracias por su inscripción, le saluda Genesis Veliz</p>');
